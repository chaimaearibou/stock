...
<header class="bg-dark text-white shadow-sm">
    <nav class="container d-flex justify-content-between align-items-center py-3">
        ...
        <div class="d-flex align-items-center gap-3">
            <a href="{{ route('dashboard') }}" class="btn btn-outline-light btn-sm">{{ trans('Dashboard') }}</a>
            
            <select name="selectLocale" id="selectLocale" class="form-select form-select-sm bg-dark text-white">
